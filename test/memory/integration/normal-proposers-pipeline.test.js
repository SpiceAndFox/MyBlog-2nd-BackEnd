...
test("normal Proposer schemas expose domain actions instead of persistent patches", () => {
...
test("normal Semantic IR compiles world fact, agreement, todo and scene domain actions", async () => {
