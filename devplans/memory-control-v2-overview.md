...
| C6   | 长期 section 写入 | `worldFacts`/`userProfile`/`assistantProfile`/`relationship` 是独立正式 section；新增只接受 `long_term_fact`，改写只接受双方 correction，同 section 内才允许合并 | write-protocol §4 |
