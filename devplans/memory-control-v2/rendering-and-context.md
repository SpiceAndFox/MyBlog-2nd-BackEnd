...
- 用户: 情绪={current.participants.user.emotion || "未知"} | 动作={current.participants.user.action || "未知"} | 意图={current.participants.user.intent || "未知"}
- 助手: 情绪={current.participants.assistant.emotion || "未知"} | 动作={current.participants.assistant.action || "未知"} | 意图={current.participants.assistant.intent || "未知"}
