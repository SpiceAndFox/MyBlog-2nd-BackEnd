...
- **目标文档**：state-contract.md §1 §2、overview.md §5、`deferred/memory-control-v2/scene-snapshot-recall.md` §2.2 §5 §6.3（该文档已 defer，仍单向同步本批变更以保持一致性，但不影响当前实现）
- **关键变更**：
...
- **目标文档**：state-contract.md §1 §2 §4 §6 §8、write-protocol.md §1.3 §5、proposer-prompt.md §2.3 §3 §4、rendering-and-context.md §1 §5、harness.md §3.6 §3.8、`deferred/memory-control-v2/scene-snapshot-recall.md` §2 §3 §5 §6（该文档已 defer，仍单向同步本批变更以保持一致性，但不影响当前实现）
- **关键变更**：
...
- **目标文档**：write-protocol.md §7 §8、state-contract.md §1 §9、rendering-and-context.md §3、overview.md §8、harness.md §3.10、`deferred/memory-control-v2/scene-snapshot-recall.md` §3.5 §6.4（该文档已 defer，仍单向同步本批变更以保持一致性，但不影响当前实现）
- **关键变更**：
...
- **目标文档**：state-contract.md §4、write-protocol.md §5、rendering-and-context.md §3、overview.md §8、harness.md、`deferred/memory-control-v2/scene-snapshot-recall.md` §4 §6.4（该文档已 defer，仍单向同步本批变更以保持一致性，但不影响当前实现）
- **关键变更**：
...
4. 未经明确确认的实现细节不得因为出现在讨论稿中就被视为已定规范；明确推迟的问题统一记录在 `deferred/memory-control-v2`。
...
10. 使用 LLM 压缩超预算 gap 的方案推迟到 [Gap Compressor 延后设计](../deferred/memory-control-v2/gap-compressor.md)。
...
8. 使用 LLM 做片段级精确 suppression 的方案推迟到 [Suppression Proposer 延后设计](../deferred/memory-control-v2/suppression-proposer.md)。
...
当前已明确延后、不进入本轮实现的问题统一记录在 [Memory Control v2 延后设计](../deferred/memory-control-v2/readme.md)，包括：
